...
const modes = [
  ...
  { id: 'twentyq', icon: '❓', name: '二十问', desc: '只问是非题，二十个问题内破案', available: false },
...
.home-skull {
  font-size: 40px;
  margin-bottom: 8px;
  filter: drop-shadow(0 0 12px var(--diablo-blood-glow));
}
.home-title {
...
.mode-entry:hover {
  ...
  box-shadow: 0 0 16px rgba(200,168,78,0.08);
}
...
.mode-sigil {
  ...
  background: linear-gradient(135deg, var(--diablo-stone), var(--diablo-bg-deep));
  flex-shrink: 0;
}
.mode-info { flex: 1; }
.mode-name {
